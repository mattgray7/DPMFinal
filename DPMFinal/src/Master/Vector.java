...
public class Vector {
	...
	/**
	 * Returns the cosine of the angle between two vectors, changed from cosTheta to cosThet, cosTheta gave a naming error
	 * @param a The first Vector
	 * @param b The second Vector
	 * @return The cosine of the angle between a and b
	 */
	public static double cosThet(Vector a, Vector b){
